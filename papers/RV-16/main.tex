...
\addtocmark{Self-Healing} % additional mark in the TOC
%
%\chapter*{Preface}
%
...
%                                     \toctitle is used
%
\author{Leonardo Mariani \and Daniela Micucci \and
Oliviero Riganelli}
%
\authorrunning{Leonardo Mariani et al.} % abbreviated author list (for running head)
%
%%%% list of authors for the TOC (use if author list has to be modified)
\tocauthor{Leonardo Mariani, Daniela Micucci,
and Oliviero Riganelli}
%
\institute{ Universit\`{a}  degli Studi di Milano Bicocca,
Viale Sarca 336,\\
IT-20126 Milan, Italy}
